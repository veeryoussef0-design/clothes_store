  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="text-center">
        ...
        <button onClick={() => { router.invalidate(); reset(); }} className="mt-4 rounded-md bg-primary px-4 py-2 text-primary-foreground">
          حاول مرة أخرى
        </button>
      </div>
    </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "متجر الأناقة - ملابس رجالى وحريمى" },
      { name: "description", content: "تسوق أحدث صيحات الملابس الرجالى والحريمى بأفضل الأسعار" },
    ],
    links: [
